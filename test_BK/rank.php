...
//        echo $total;
    ...
    while($row = mysql_fetch_assoc($result)){
        ...
        echo"<a href=\"".$url."\" target=\"video\"><div style=\"font-size:12px;vertical-align:top;cursor:pointer;width:120px;height:92px;display:inline-block;overflow:hidden\"><div style=\"height:66px;display:inline-block;overflow:hidden\"><img style=\"margin-top:-12px\" src=\"//i.ytimg.com/vi/".$row['v']."/default.jpg\" height=\"90\" width=\"120\"></div><div style=\"display:inline-block\">".$title."</div></div></a>\n";
        $i = $i + 1;
    }
